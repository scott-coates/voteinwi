        ...
        /> */}
          ...
          <div className="leading-loose p-3">
            ...
            <p className="mb-3">
              ...
              Election Day, it&apos;s super easy to register other ways, here
              are the deadlines for each method:
            </p>
            <ul className="list-disc list-outside mb-6 pl-4">
              <li className="">
              ...
              <InfoBox title="Having troubles registering online?">
                <ul className="pt-4">
                  <li className="pb-2">
                    ...
                    and ask for help. Additionally, request that they add your
                    address to the WisVote system.
                  </li>
