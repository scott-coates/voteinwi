    ...
    <Layout>
      ...
      <div className="space-y-12 mb-48">
        ...
        /> */}
          ...
          <div className="mb-3">
            <InfoBox
              title="Want to volunteer for your local election office?
"
            >
              <ul className="pt-4">
                <li className="pb-2">
                ...
                <li className="pb-2">
                  Each city, village and town in Wisconsin is responsible for
                  setting the dates and hours of in-person absentee voting for
                  their municipality. To find the dates and hours for in-person
                  absentee voting where you live,
                  <a
                    className="no-underline text-blue-700 hover:text-blue-800"
                    href="https://myvote.wi.gov/en-US/MyMunicipalClerk"
                  >
